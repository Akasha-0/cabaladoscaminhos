...
const MATERIAL_SPIRITUAL_CORRELATIONS: Record<
  string,
  {
    sefirot: string[];
    chakra: number;
...
> = {
  Aether: {
    ...
    element: 'Éter',
    orixa: 'Oxalá',
    affirmation: 'O éter conecta todos os elementos',
    frequency: '963 Hz',
  },
  'Spirit Dust': {
    ...
    element: 'Água',
    orixa: 'Iemanjá',
    affirmation: 'O pó espiritual limpa a consciência',
    frequency: '639 Hz',
  },
  'Celestial Shard': {
    ...
    element: 'Fogo',
    orixa: 'Xangô',
    affirmation: 'O fragmento celestial traz luz',
    frequency: '528 Hz',
  },
  'Sacred Herbs': {
    ...
    element: 'Fogo',
    orixa: 'Ogum',
    affirmation: 'As ervas sagradas curam e protegem',
    frequency: '396 Hz',
  },
  'Ritual Water': {
    sefirot: ['Binah', 'Yesod'],
    ...
    element: 'Água',
    orixa: 'Oxum',
    affirmation: 'A água ritual lava impurezas',
    frequency: '639 Hz',
  },
};
...
const MATERIALS: Material[] = [
  {
    ...
    type: 'elemental',
    rarity: 'legendary',
    properties: { element: 'eter' },
    description: 'Quintessência espiritual',
    spiritualCorrelations: MATERIAL_SPIRITUAL_CORRELATIONS['Aether'],
  },
  {
    id: '2',
    name: 'Spirit Dust',
    type: 'essence',
    rarity: 'rare',
    properties: { chakra: ['coroa', 'terceiro-olho'] },
    description: 'Pó de essência espiritual',
    spiritualCorrelations: MATERIAL_SPIRITUAL_CORRELATIONS['Spirit Dust'],
  },
  {
    id: '3',
    ...
    type: 'crystal',
    rarity: 'epic',
    properties: { element: 'luz' },
    description: 'Fragmento celestial',
    spiritualCorrelations: MATERIAL_SPIRITUAL_CORRELATIONS['Celestial Shard'],
  },
  {
    id: '4',
    name: 'Sacred Herbs',
    type: 'herb',
    rarity: 'common',
    properties: { orixa: ['Oxum', 'Iemanjá'] },
    description: 'Ervas sagradas',
    spiritualCorrelations: MATERIAL_SPIRITUAL_CORRELATIONS['Sacred Herbs'],
  },
  {
    id: '5',
    name: 'Ritual Water',
    type: 'ritual',
    rarity: 'uncommon',
    properties: { element: 'agua', orixa: ['Oxum'] },
    description: 'Água ritualística',
    spiritualCorrelations: MATERIAL_SPIRITUAL_CORRELATIONS['Ritual Water'],
  },
  {
    id: '6',
    name: 'Obsidiana',
    type: 'crystal',
    rarity: 'epic',
    properties: { element: 'terra' },
    description: 'Pedra de proteção ancestral',
    spiritualCorrelations: {
      sefirot: ['Malkuth', 'Gevurah'],
      chakra: 1,
      element: 'Terra',
      orixa: 'Ogum',
      affirmation: 'A obsidiana protege contra negatividades',
      frequency: '174 Hz',
    },
  },
  {
    ...
    type: 'herb',
    rarity: 'common',
    properties: { element: 'fogo' },
    description: 'Erva de purificação e sabedoria',
    spiritualCorrelations: {
      sefirot: ['Hod', 'Netzach'],
      chakra: 5,
      element: 'Fogo',
      orixa: 'Oxalá',
      affirmation: 'O salvio purifica meu espaço',
      frequency: '741 Hz',
    },
  },
  {
    id: '8',
    name: 'Incenso de Palo Santo',
    type: 'ritual',
    rarity: 'rare',
    properties: { element: 'ar' },
    description: 'Fumação sagrada para limpeza energética',
    spiritualCorrelations: {
      sefirot: ['Chokhmah', 'Kether'],
      chakra: 7,
      element: 'Ar',
      orixa: 'Oxalá',
      affirmation: 'O palo santo eleva minha vibração',
      frequency: '852 Hz',
    },
  },
  {
    ...
    rarity: 'uncommon',
    properties: { element: 'eter' },
    description: 'Amplificador de energia espiritual',
    spiritualCorrelations: {
      sefirot: ['Kether', 'Binah'],
      chakra: 7,
      element: 'Éter',
      orixa: 'Oxalá',
      affirmation: 'O quartzo amplifica minha intenção',
      frequency: '963 Hz',
    },
  },
  {
    ...
    rarity: 'legendary',
    properties: { element: 'agua', orixa: ['Oxum'] },
    description: 'Oferta sagrada para Oxum',
    spiritualCorrelations: {
      sefirot: ['Tipheret', 'Chesed'],
      chakra: 4,
      element: 'Água',
      orixa: 'Oxum',
      affirmation: 'O mel atrai prosperidade e amor',
      frequency: '528 Hz',
    },
  },
  {
    ...
    type: 'symbolic',
    rarity: 'epic',
    properties: { element: 'terra', orixa: ['Ogum'] },
    description: 'Ferramenta ritual de Ogum',
    spiritualCorrelations: {
      sefirot: ['Malkuth', 'Gevurah'],
      chakra: 1,
      element: 'Terra',
      orixa: 'Ogum',
      affirmation: 'O ferro abre todos os caminhos',
      frequency: '174 Hz',
    },
  },
  {
    ...
    type: 'ritual',
    rarity: 'common',
    properties: { element: 'fogo', orixa: ['Oxalá'] },
    description: 'Vela de paz e proteção',
    spiritualCorrelations: {
      sefirot: ['Kether', 'Tipheret'],
      chakra: 7,
      element: 'Fogo',
      orixa: 'Oxalá',
      affirmation: 'A vela branca ilumina meu caminho',
      frequency: '963 Hz',
    },
  },
];
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!name || !type) {
      return NextResponse.json(
        { success: false, error: 'Nome e tipo requeridos' },
        { status: 400 }
      );
    }
