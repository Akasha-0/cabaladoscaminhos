...
const TANTRIC_PRACTICES = [
  ...
  },
  {
    ...
    sanskrit: 'यब्ज्म्',
    description: 'Tantric meditation posture representing the union of wisdom and compassion',
    category: 'posture',
    level: 'intermediate',
...
const TANTRIC_CHAKRAS = [
  {
    ...
    psychologicalAspects: ['survival', 'grounding', 'security'],
    tantricAspect: 'kundalini_seat',
  ...
  },
  {
    ...
    psychologicalAspects: ['creativity', 'sexuality', 'emotions'],
    tantricAspect: 'creative_energy_center',
  ...
  },
  {
    ...
    psychologicalAspects: ['willpower', 'personal_power', 'digestion'],
    tantricAspect: 'power_center',
  ...
  },
  {
    ...
    psychologicalAspects: ['love', 'compassion', 'balance'],
    tantricAspect: 'center_of_union',
  ...
  },
  {
    ...
    psychologicalAspects: ['expression', 'communication', 'truth'],
    tantricAspect: 'purification_center',
  ...
  },
  {
    ...
    psychologicalAspects: ['intuition', 'wisdom', 'insight'],
    tantricAspect: 'command_center',
  ...
  },
  {
    ...
    psychologicalAspects: ['enlightenment', 'divine_connection', 'transcendence'],
    tantricAspect: 'union_with_divine',
...
const TANTRIC_ENERGIES = {
  shakti: {
    ...
    qualities: ['creative', 'transformative', 'nourishing'],
  ...
  shiva: {
    ...
    qualities: ['witnessing', 'meditative', 'liberating'],
  ...
  union: {
    ...
    aspects: ['balance', 'integration', 'wholeness'],
