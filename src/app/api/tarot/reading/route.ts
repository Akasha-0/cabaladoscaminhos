...
const MAJOR_ARCANA_SPIRITUAL_CORRELATIONS: Record<number, {
  ...
  0: { sefirot: ['Kether'], chakra: 7, element: 'Éter', orixa: 'Oxalá', affirmation: 'O véu se levanta e a sabedoria emerge', frequency: '963 Hz' }, // The Fool
  ...
  6: { sefirot: ['Netzach'], chakra: 4, element: 'Fogo', orixa: 'Oxum', affirmation: 'O lovers me guiam para união divina', frequency: '528 Hz' }, // The Lovers
  ...
  8: { sefirot: ['Chesed', 'Gevurah'], chakra: 4, element: 'Água', orixa: 'Iemanjá', affirmation: 'A força interior supera todos os obstáculos', frequency: '528 Hz' }, // Strength
  9: { sefirot: ['Hod'], chakra: 5, element: 'Ar', orixa: 'Iansã', affirmation: 'O ermitão busca a luz interior', frequency: '741 Hz' }, // The Hermit
  ...
  11: { sefirot: ['Gevurah', 'Netzach'], chakra: 3, element: 'Terra', orixa: 'Nanã', affirmation: 'A justiça divina restaura o equilíbrio', frequency: '528 Hz' }, // Justice
  ...
  13: { sefirot: ['Malkuth', 'Yesod'], chakra: 1, element: 'Água', orixa: 'Iemanjá', affirmation: 'A morte traz transformação e renascimento', frequency: '417 Hz' }, // Death
  14: { sefirot: ['Tipheret'], chakra: 4, element: 'Fogo', orixa: 'Oxum', affirmation: 'A temperança equilibra corpo e alma', frequency: '528 Hz' }, // Temperance
  ...
  16: { sefirot: ['Kether', 'Malkuth'], chakra: 7, element: 'Fogo', orixa: 'Oxalá', affirmation: 'A torre cai para rebuild my foundation', frequency: '963 Hz' }, // The Tower
  17: { sefirot: ['Yesod', 'Netzach'], chakra: 6, element: 'Fogo', orixa: 'Oxum', affirmation: 'A estrela me conecta à luz divina', frequency: '528 Hz' }, // The Star
  ...
  20: { sefirot: ['Kether', 'Tipheret'], chakra: 7, element: 'Éter', orixa: 'Oxalá', affirmation: 'O julgamento traz redenção', frequency: '963 Hz' }, // Judgement
