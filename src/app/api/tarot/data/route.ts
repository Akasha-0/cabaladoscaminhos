...
const MAJOR_ARCANA_CARDS: TarotCard[] = [
  ...
  { id: 5, name: 'O Papa', arcana: 'major', upright: ['Tradição', 'Espiritualidade', 'Dogma'], reversed: ['Rebeldia', 'Novas ideias'] },
  ...
  { id: 12, name: 'O Enforcado', arcana: 'major', upright: ['Sacrifício', 'Nova perspectiva', 'Adiação'], reversed: ['Stagnation', 'Resistência'] },
  ...
  { id: 19, name: 'O Sol', arcana: 'major', upright: ['Sucesso', 'Vitalidade', 'Alegria'], reversed: ['Bloeio temporário', 'Optimismo exagerado'] },
  { id: 20, name: 'O Julgamento', arcana: 'major', upright: ['Juízo', 'Renascimento', 'Propósito'], reversed: ['Auto-repreensão', 'Ignorar a consciência'] },
  { id: 21, name: 'O Mundo', arcana: 'major', upright: ['Completude', 'Realização', 'Harmonia'], reversed: ['Incompletion', 'Frustração'] },
];
...
const MINOR_ARCANA_CARDS: TarotCard[] = [
  ...
  { id: 45, name: 'Dez de Copas', arcana: 'minor', suit: 'Copas', number: 10, element: 'Água', upright: ['Felicidade familiar', 'Harmonia', 'Perfeição'], reversed: ['Disharmony', 'Frustração familiar'] },
  ...
  { id: 51, name: 'Dois de Espadas', arcana: 'minor', suit: 'Espadas', number: 2, element: 'Ar', upright: ['Indecision', 'Paralys', 'Escolha difícil'], reversed: ['Indecision', 'Confusão'] },
  ...
  { id: 60, name: 'Princesa de Espadas', arcana: 'minor', suit: 'Espadas', number: 11, element: 'Ar', upright: ['Curiosidade', 'Verdade', 'Clareza'], reversed: ['CMalice', 'Fofoca'] },
  ...
  { id: 62, name: 'Rainha de Espadas', arcana: 'minor', suit: 'Espadas', number: 13, element: 'Ar', upright: ['Independência', 'Lógica', 'Objectividade'], reversed: ['Cold-heartedness', 'Crueldade'] },
...
const CARD_INTERPRETATIONS: CardInterpretation[] = [
  ...
  { cardName: 'O Mundo', tags: ['completude', 'realização', 'harmonia', 'integração'], summary: 'Completude e realização de um ciclo completo.', general: 'O Mundo representa completude, realização e harmonia. Ele indica que um ciclo importante está completo e você alcançou integração.', love: 'Realização no amor, harmonia no relacionamento, completude emocional.', career: 'Sucesso completo na carreira, realização profissional, fim bem-sucedido de um projeto.', shadow: ['Incompletion', 'frustração', 'sentir que falta algo'], affirmations: ['Completude é minha realidade', 'Realizei meu potencial', 'Harmonia e integração me guiam'] },
];
