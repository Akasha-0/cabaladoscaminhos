...
function enrichContentItem(item: EnrichedContentItem): EnrichedContentItem & { spiritualCorrelations: Record<string, string | number | string[]> } {
  ...
  return {
    ...item,
    spiritualCorrelations: { sefirot: corr.sefirot, chakra: corr.chakra, element: corr.element, orixa: corr.orixa, affirmation: corr.affirmation, frequency: corr.frequency },
  };
}
