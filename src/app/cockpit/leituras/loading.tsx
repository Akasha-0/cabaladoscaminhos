/**
 * loading.tsx — Skeleton de loading para /cockpit/leituras
...
export default function LeiturasLoading(): React.JSX.Element {
  return (
    <div className="ramiro min-h-[60vh] flex flex-col items-center justify-center gap-4 p-8">
      ...
      <p className="text-sm text-zinc-600 dark:text-zinc-400 animate-pulse">Carregando leituras…</p>
    </div>
  );
}
