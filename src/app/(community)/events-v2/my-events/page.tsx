...
// ============================================================================
// MY EVENTS — /events-v2/my-events
// ============================================================================
// Lista de eventos do usuário:
//   • Going (próximos + passados)
//   • Organized (eventos onde user é host)
//   • Tabs para alternar
// ============================================================================
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        // Para "going", filtrar só eventos com viewerRsvp=GOING/WAITLIST
        if (tab === 'going') {
