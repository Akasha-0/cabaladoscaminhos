...
/**
 * Wave 21 — Group detail page error boundary.
 *
 * Captura erros lançados durante o render ou fetch do
 * (community)/groups/[slug]/page.tsx e exibe uma mensagem clara com
 * opções de retry / retorno seguro.
 */
      ...
      <div className="max-w-md w-full text-center space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            Tivemos um problema para buscar os dados do grupo. Pode ser uma
            falha temporária de rede — tente novamente.
          </p>
        </div>
        {error.digest && (
