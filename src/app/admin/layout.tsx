...
//
// W29 (2026-06-29) — Movido de src/app/(admin)/layout.tsx. O route group
// `(admin)` não adiciona path, então admin estava vivendo em /dashboard,
// /users, /moderation (sem prefixo) e colidia com a comunidade. Agora vive
// em /admin/* como o resto do código espera.
// ============================================================================
