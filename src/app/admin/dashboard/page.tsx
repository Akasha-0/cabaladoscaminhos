...
//
// W29 (2026-06-29) — Movido de src/app/(admin)/dashboard/page.tsx para
// resolver a colisão de rotas com src/app/(community)/dashboard/page.tsx
// (ambos resolviam para /dashboard). Admin agora vive em /admin/* (sem
// route group) como AdminNav e o restante do código já esperavam.
// ============================================================================
