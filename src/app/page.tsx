...
const features = [
  {
    ...
    description:
      'Descubra seu caminho de vida através da astrologia cabalística e alinhamento cósmico.',
    color: 'amber',
  },
  {
    icon: Hash,
  ...
  },
  {
    ...
    description:
      'Calcule seu número de vida e desperte seu potencial através da numerologia sagrada.',
    color: 'gold',
  },
  {
    icon: TreePine,
      ...
      <div className="relative z-10 min-h-screen text-white scroll-smooth">
          ...
          <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:flex items-center gap-8">
                ...
                <MysticButton variant="outline" size="sm" className="hidden md:inline-flex">
        ...
        <section className="relative min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden flex items-center">
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
            ...
            />
            <div
              className="absolute top-2/3 right-1/3 w-1 h-1 bg-amber-400 rounded-full animate-twinkle opacity-70"
            ...
            />
            <div
              className="absolute top-1/4 right-1/6 w-1 h-1 bg-amber-300 rounded-full animate-twinkle opacity-50"
              style={{ animationDelay: '0.8s' }}
            />
            <div
              className="absolute bottom-1/3 right-1/4 w-1 h-1 bg-amber-400 rounded-full animate-twinkle opacity-60"
              style={{ animationDelay: '1.2s' }}
            />
            <div
              className="absolute top-1/6 left-1/2 w-0.5 h-0.5 bg-violet-400 rounded-full animate-twinkle opacity-40"
              style={{ animationDelay: '2s' }}
            />
            <div
              className="absolute bottom-1/6 left-1/4 w-0.5 h-0.5 bg-emerald-400 rounded-full animate-twinkle opacity-50"
          ...
          {/* Gradient orbs */}
          <div
            className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-amber-500/10 rounded-full blur-3xl animate-pulse-soft"
            aria-hidden="true"
          />
          <div
            className="absolute bottom-1/4 left-1/2 -translate-x-1/2 w-80 h-80 bg-violet-500/5 rounded-full blur-3xl animate-pulse-soft"
            style={{ animationDelay: '1s' }}
            aria-hidden="true"
          />
          <div
            className="absolute top-1/2 right-1/4 w-64 h-64 bg-emerald-500/5 rounded-full blur-3xl animate-pulse-soft"
            style={{ animationDelay: '2s' }}
            aria-hidden="true"
          />
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              ...
              >
                A tecnologia sagrada de alinhamento entre você e o cosmos. Descubra seu caminho de
                vida através da <span className="text-amber-400 font-medium">Cabala</span>,{' '}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 max-w-5xl mx-auto">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <span className="text-sm text-slate-400 font-raleway">{stat.label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="container mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-400 text-lg max-w-2xl mx-auto font-raleway">
                Explore as古老的 sabedorias unidas à tecnologia moderna para seu desenvolvimento
                espiritual.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {features.map((feature, index) => (
                ...
                >
                  <CardHeader>
                    <div
                      className={`w-14 h-14 rounded-xl bg-gradient-to-br ${chakraBgColors[feature.color]} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-500 group-hover:shadow-[0_0_20px_rgba(212,175,55,0.2)]`}
                    >
                      <feature.icon
                        className={`w-7 h-7 ${chakraColors[feature.color]} group-hover:rotate-6 transition-transform duration-500`}
                      />
                    </div>
              ...
              {/* CTA Card */}
              <Card
                className="bg-gradient-to-br from-amber-500/20 to-amber-600/10 border-amber-500/30 md:col-span-2 lg:col-span-3 animate-fade-in-up group hover:shadow-[0_0_50px_rgba(212,175,55,0.2)] transition-all duration-500"
        ...
        <section
          id="como-funciona"
          className="py-20 px-4 sm:px-6 lg:px-8 scroll-mt-20 bg-gradient-to-b from-transparent via-violet-500/5 to-transparent"
        >
          <div className="container mx-auto">
            <div className="text-center mb-16">
              <Heading variant="section" glow="gold" className="mb-4">
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className="relative z-10 text-center p-8 rounded-2xl bg-gradient-to-br from-white/[0.03] to-transparent border border-amber-500/20 hover:border-amber-500/40 hover:bg-white/[0.05] transition-all duration-500 hover:shadow-[0_0_50px_rgba(212,175,55,0.15)] group-hover:-translate-y-2 transition-transform duration-500">
                    {/* Step number badge */}
                    <div
                      className={`w-16 h-16 rounded-full bg-gradient-to-br ${step.color} border-2 ${step.borderColor} flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(212,175,55,0.3)] transition-all duration-500`}
                    >
                    ...
                    {/* Icon */}
                    <div
                      className={`w-12 h-12 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-500`}
                    >
                ...
                >
                  <CardContent className="pt-6 pb-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-white font-medium font-raleway">{testimonial.name}</p>
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-300 mb-10 font-raleway leading-relaxed">
                Milhares de pessoas já descobriram seu caminho. Seja o próximo a despertar para sua
                verdadeira essência.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Link href="/login">
                  <MysticButton variant="outline" size="lg" className="text-lg px-10 h-14">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-slate-400 font-raleway max-w-sm mb-4">
                  Tecnologia sagrada de alinhamento espiritual. Conectando você ao cosmos através
                  da古老的 sabedoria.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <Link
                      href="/calendario"
                      className="text-slate-400 hover:text-amber-400 transition-colors font-raleway"
                    >
                      Calendário
                    </Link>
                  </li>
