...
const MEANINGS: Record<number, NumberMeaning> = {
  ...
  2: { numero: 2, nome: 'Diplomático', planeta: 'Lua', significado: 'Parceria, cooperação, receptividade', forca: 'Equilíbrio, adaptabilidade', desafio: 'Conflito interno, indecisão', sefira: 'Chokhmah', arco: 'II', cor: 'Prata', pedra: 'Pérola', qualidade: 'Cardeal', palavraChave: ['parceria', 'cooperação', 'receptividade'], affirmation: 'Eu colboro em harmonia e mutualidade' },
  ...
  6: { numero: 6, nome: 'Harmonizador', planeta: 'Vênus', significado: 'Família, responsabilidade, beleza', forca: 'Compaixão, serviço', desafio: 'Autocomplacência, martyr', sefira: 'Tipheret', arco: 'VI', cor: 'Rosa', pedra: 'Rodocrosita', qualidade: 'Composto', palavraChave: ['harmonia', 'família', 'responsabilidade'], affirmation: 'Eu amo e sirvo com equilíbrio' },
  ...
  8: { numero: 8, nome: 'Realizador', planeta: 'Saturno', significado: 'Poder, realizações, karma', forca: 'Abundância, mastersia', desafio: 'Materialismo, autoritarismo', sefira: 'Hod', arco: 'VIII', cor: 'Ferro', pedra: 'Ônix', qualidade: 'Fixo', palavraChave: ['realização', 'poder', 'karma'], affirmation: 'Eu manifesto abundância com integridade' },
