 ...
 * Each card contains complete interpretation for Mesa Real readings.
 */
...
// Theme houses from IDEIA.md pp.130-131
export const CASAS_TEMATICAS = {
  DINHEIRO: [34, 15],      // Peixes, Urso - Money and business
  AMOR: [24, 25],           // Coração, Anel - Love and relationships
  TRABALHO: [35, 14],       // Âncora, Raposa - Work and employment
  SAUDE: [5, 8],            // Árvore, Caixão - Physical health
} as const;
