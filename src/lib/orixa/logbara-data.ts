...
A abundância flui quando honramos nossa beleza interior e exterior com gratidão
e generosidade.',
  affirmation: 'Eu sou merecedor(a) de toda a prosperidade e beleza que a vida oferece.
A riqueza flui em minha direção naturalmente.',
  meditation: 'Sinto as águas douradas de Logbara envolvendo meu corpo, purificando
e abençoando cada parte de mim. Sua luz dourada traz abundância e amor.',
  herbs: [
    {
      name: 'margarida',
