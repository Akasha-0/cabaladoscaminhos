...
const IRON_MEJI_DATA: IronMejiOdu[] = [
  {
    ...
    taboos: ['Não usar armas de mentira', 'Não quebrar promessas', 'Não fazer oferendas improvisadas'],
  ...
  },
  {
    ...
    taboos: ['Não mentir', 'Não consumir sal em excesso', 'Não desrespeitar os mais velhos'],
  ...
  },
  {
    ...
    taboos: ['Não usar armas', 'Não cortar árvores', 'Não destruir o sagrado'],
  ...
  },
  {
    ...
    taboos: ['Não mudar de lugar', 'Não acumular riqueza excessivamente', 'Não desrespeitar as regras'],
  ...
  },
  {
    ...
    taboos: ['Não trair', 'Não mentir', 'Não fazer declarações falsas'],
  ...
  },
  {
    ...
    taboos: ['Não huir', 'Não desistir', 'Não fugir das responsabilidades'],
