/**
 * w36/mentorship-graduation-flow.ts
 *
 * Mentorship completion + alumni transition flow.
 * Handles graduation ceremony, certificate generation, alumni status
 * assignment, and follow-up cadence recommendations.
 *
 * Composes:
