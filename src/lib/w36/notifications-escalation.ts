/**
 * w36/notifications-escalation.ts
 *
 * Digest → push escalation flow for stale notifications.
 * Decides when a queued notification should be re-sent via push (or other
 * channels) because it has not been seen, replied to, or dismissed in time.
 *
 * Composes:
