/**
 * w36/marketplace-leitura-bundles.ts
 *
 * Group purchase, gift, and multi-leitura packages for the marketplace.
 * Allows users to bundle multiple leitura sessions (own consumption or gift)
 * and apply progressive discounts.
 *
 * Composes:
...
export function buildGroupBundle(
  ...
  // perPersonCents available for downstream split logic
  void perPersonCents;
}
