...
export const ODU_ZODIAC_MAPPINGS: Record<number, OduZodiac> = {
  ...
  8: { odu_numero: 8, odu_nome: 'Osí', odu_nome_yoruba: 'Ejìọnlá', signo: 'Escorpião', elemento: 'água', significado_espiritual: 'Transformação profunda, regeneração, mistério. Morte e renascimento espiritual.', mensagem_central: 'Das cinzas surge a força. Ejionlá desperta o poder transformador.' },
