...
export const ODU_ZODIAC_MAPPINGS: Record<number, OduZodiac> = {
  1: { odu_numero: 1, odu_nome: 'Ogbe', odu_nome_yoruba: 'Okànràn', signo: 'Áries', elemento: 'fogo', significado_espiritual: 'Coragem, recomeço, pioneirismo. Odu do líder que abre caminhos e da chama que acende novas jornadas.', mensagem_central: 'A coragem move montanhas. Okaran traz a força do fogo para iniciar.' },
  ...
  3: { odu_numero: 3, odu_nome: 'Etogundá', odu_nome_yoruba: 'Ẹtaọgúndá', signo: 'Gêmeos', elemento: 'ar', significado_espiritual: 'Comunicação, dualidade, transformação. Reflete a natureza mutável e a capacidade de adaptar-se.', mensagem_central: 'A fluidez entre opostos traz sabedoria. Etaogundá abre portas da comunicação.' },
  ...
  8: { odu_numero: 8, odu_nome: 'Ejionile', odu_nome_yoruba: 'Ejìọnlá', signo: 'Escorpião', elemento: 'água', significado_espiritual: 'Transformação profunda, regeneração, mistério. Morte e renascimento espiritual.', mensagem_central: 'Das cinzas surge a força. Ejionlá desperta o poder transformador.' },
  9: { odu_numero: 9, odu_nome: 'Ossá', odu_nome_yoruba: 'Ọ̀shẹ́', signo: 'Sagitário', elemento: 'fogo', significado_espiritual: 'Expansão, fé, aventura espiritual. Busca por significado e conexão com o divino.', mensagem_central: 'O conhecimento ilumina a jornada. Oshe expande horizontes.' },
  ...
  11: { odu_numero: 11, odu_nome: 'Owarin', odu_nome_yoruba: 'Èyọ́nlá', signo: 'Aquário', elemento: 'ar', significado_espiritual: 'Inovação, humanitarianismo, sabedoria libertária. Visão que transcende convenções.', mensagem_central: 'A sabedoria libertária transforma. Eyonla abre a mente para o novo.' },
  12: { odu_numero: 12, odu_nome: 'Ejilaxebô', odu_nome_yoruba: 'Mẹ̀rìnlá', signo: 'Peixes', elemento: 'água', significado_espiritual: 'Unidade cósmica, sacrifício, compaixão infinita. Dissolução de fronteiras entre self e universo.', mensagem_central: 'A compaixão une todos os seres. Merinla dissolve o véu entre dimensões.' },
  13: { odu_numero: 13, odu_nome: 'Oturupon', odu_nome_yoruba: 'Mẹ̀rọ̀', signo: 'Áries', elemento: 'fogo', significado_espiritual: 'Descoberta, tesouros ocultos, revelação. Prosperidade que surge do inesperado e da coragem.', mensagem_central: 'Tesouros escondidos esperam coragem. Mero revela a riqueza do caminho.' },
  14: { odu_numero: 14, odu_nome: 'Oturá', odu_nome_yoruba: 'Jìnza', signo: 'Touro', elemento: 'terra', significado_espiritual: 'Força interior, proteção, vitória. Batalha espiritual ganha através da determinação inabalável.', mensagem_central: 'A determinação vence obstáculos. Jinza traz a força do guerreiro.' },
  15: { odu_numero: 15, odu_nome: 'Iká', odu_nome_yoruba: 'Jọ́tágbè', signo: 'Gêmeos', elemento: 'ar', significado_espiritual: 'Comunicação ancestral, linhagem espiritual. Conexão entre passado e presente através da palavra sagrada.', mensagem_central: 'A ancestralidade fala através de ti. Jotagbe abre canais de sabedoria.' },
  16: { odu_numero: 16, odu_nome: 'Ofurufu', odu_nome_yoruba: 'Òtúrá', signo: 'Câncer', elemento: 'água', significado_espiritual: 'Jornada, destino, caminho revelado. O destino se forma a cada passo da jornada.', mensagem_central: 'O caminho se revela na caminhada. Otura orienta a jornada do destino.' },
};
