...
/**
 * Represents the correlation between a Tarot Major Arcana card and its planet
 */
export interface TarotPlanetMapping {
  ...
  numero_carta: number;
  /** The associated classical planet */
  planeta: string;
...
export const TAROT_PLANET_MAPPINGS: Record<string, TarotPlanetMapping> = {
  ...
  'A Imperatriz': {
    ...
    significado_espiritual: 'Amor incondicional, fertilidade, criação abundante e conexão com o divine feminino. A mãe natureza que nutre e prospera.',
...
/**
 * Get the arcano name corresponding to a planet
