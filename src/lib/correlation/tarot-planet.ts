...
export const TAROT_PLANET_MAP: Record<number, TarotPlanetMapping> = {
  ...
  0: {
    ...
    elemento: 'Ar',
    significado_spiritual: {
      descricao: 'O início da jornada espiritual, representando a quebra das limitações e a abertura para o novo.',
  ...
  // IV. O Imperador - Marte - Authority, structure, father figure
  4: {
    arcano: 'O Imperador',
    numero_carta: 4,
    planeta: 'Marte',
  ...
  // VIII. A Justiça - Saturno - Justice, fairness, truth
  8: {
    arcano: 'A Justiça',
    numero_carta: 8,
    planeta: 'Saturno',
  ...
  // XI. A Força - Netuno - Courage, patience, inner strength
  11: {
    arcano: 'A Força',
    numero_carta: 11,
    planeta: 'Netuno',
  ...
  // XII. O Eremita (invertido) - Mercúrio - Surrender, letting go
  12: {
  ...
  // XIV. A Temperança - Netuno - Balance, moderation, patience
  14: {
    arcano: 'A Temperança',
    numero_carta: 14,
    planeta: 'Neteno',
  ...
  // XV. O Diabo - Saturno - Shadow, bondage, material world
  15: {
    arcano: 'O Diabo',
    numero_carta: 15,
    planeta: 'Saturno',
  ...
  // XVII. A Estrela - Vénus - Hope, faith, future
  17: {
    arcano: 'A Estrela',
    numero_carta: 17,
    planeta: 'Vénus',
  ...
  // XX. O Julgamento - Plutão - Judgment, rebirth, calling
  20: {
    arcano: 'O Julgamento',
    numero_carta: 20,
    planeta: 'Plutão',
  ...
  // XXI. O Mundo - Saturno - Completion, integration, accomplishment
  21: {
    arcano: 'O Mundo',
    numero_carta: 21,
    planeta: 'Saturno',
    elemento: 'Terra',
    significado_spiritual: {
      descricao: 'A conclusão da jornada cíclica e a integração de todas as lições aprendidas.',
      qualidade_cosmica: 'Conclusão e integração',
      lição_espiritual: 'Celebrar a conclusão de um ciclo e preparar-se para um novo.',
    },
    energia_manifestacao: {
      foco: 'Conclusão e accomplishment',
      força: 'Logro, integración, plenitude, paz',
      sombra: 'Satisfação, complacência, stagnation',
    },
  },
};
