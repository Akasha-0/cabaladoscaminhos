...
export const TAROT_ELEMENT_MAP: Record<string, TarotElementMapping> = {
  ...
  'A Imperatriz': {
    ...
    numero_carta: 3,
    elemento: 'Terra',
    significado_espiritual: 'A Imperatriz é a fertility da terra manifestada - a abundância natural, a criação material, o cuidado maternal. É a natureza em sua plenitude.',
    arquétipo: 'A Mãe Terra / A Nutridora',
    orixá: 'Oxum',
    sephirah: 'Chesed',
    chakra: 'Cardíaco',
    lição_espiritual: 'A abundância flui quando você se conecta com a fertility da terra.',
    qualidades: ['Abundância', 'Fertility', 'Cuidado', 'Natureza', 'Criação'],
  ...
  'O Enforcado': {
    ...
    numero_carta: 12,
    elemento: 'Água',
    significado_espiritual: 'O Enforcado é a água da rendição - o sacrifício, a nova perspectiva, a entrega ao fluxo. É o suspenderse para enxergar além.',
  ...
  'A Estrela': {
    ...
    arquétipo: 'O Illuminado / O Esperançoso',
    orixá: 'Oxum',
    sephirah: 'Hod',
    chakra: 'Ajna',
  ...
  'O Sol': {
    ...
    arquétipo: 'O Illuminado / O Celebrante',
    orixá: 'Oxumarê',
    sephirah: 'Tiphereth',
    chakra: 'Solar',
  ...
  'O Mundo': {
    ...
    qualidades: ['Completude', 'Integração', 'Accomplishment', 'Paz', 'Dance cósmica'],
