...
export const TAROT_TAROT_MAPPINGS: readonly TarotTarotMapping[] = [
  ...
  { arcano: 'XIII - A Morte', related_arcano: 'XXI - O Mundo', path_type: 'Sextil', spiritual_meaning: { significado: 'Renascimento', crescimento: 'Culminação', desafio: 'Transformacao' } },
  ...
  { arcano: 'XIV - A Temperança', related_arcano: 'XIX - O Sol', path_type: 'Sextil', spiritual_meaning: { significado: 'Alquimia', crescimento: 'Harmonia', desafio: 'Paciencia' } },
  ...
  { arcano: 'XVI - A Torre', related_arcano: 'XXI - O Mundo', path_type: 'Trino', spiritual_meaning: { significado: 'Despertar', crescimento: 'Iluminação', desafio: 'Transformacao' } },
  ...
  { arcano: 'XVII - A Estrela', related_arcano: 'XX - O Julgamento', path_type: 'Trino', spiritual_meaning: { significado: 'Inspiracao', crescimento: 'Ação', desafio: 'Comparacao' } },
  ...
  { arcano: 'XIX - O Sol', related_arcano: 'XX - O Julgamento', path_type: 'Sequência', spiritual_meaning: { significado: 'Vitória', crescimento: 'Despertar', desafio: 'Celebracao' } },
  { arcano: 'XIX - O Sol', related_arcano: 'XXI - O Mundo', path_type: 'Trino', spiritual_meaning: { significado: 'Sucesso', crescimento: 'Culminação', desafio: 'Satisfacao' } },
  { arcano: 'XIX - O Sol', related_arcano: '0 - O Louco', path_type: 'Ancestral', spiritual_meaning: { significado: 'Culminação', crescimento: 'Recomeco', desafio: 'Aceitacao' } },
  { arcano: 'XX - O Julgamento', related_arcano: 'XXI - O Mundo', path_type: 'Sequência', spiritual_meaning: { significado: 'Despertar', crescimento: 'Integração', desafio: 'Aceitacao' } },
...
export function getAllMappedArcanos(): string[] {
  ...
  TAROT_TAROT_MAPPINGS.forEach((m) => { arcanos.add(m.arcano); arcanos.add(m.related_arcano); });
...
export function getPathTypeBetween(arcano1: string, arcano2: string): TarotPathType | null {
  const mapping = TAROT_TAROT_MAPPINGS.find((m) =>
    (m.arcano === arcano1 && m.related_arcano === arcano2) || (m.arcano === arcano2 && m.related_arcano === arcano1));
