...
export const ODTU_FREQUENCY_MAPPINGS: Record<number, OdTuFrequency> = {
  ...
  1: {
    ...
    propriedades_healing: {
      ...
      espiritual:
        'Conexão com a energia criadora primordial, abertura para novos ciclos de vida.',
    },
  },
  ...
  2: {
    ...
    propriedades_healing: {
      ...
      espiritual:
        'Integração de polaridades, sabedoria para escolher caminhos equilibrados.',
    },
  },
  ...
  6: {
    ...
    propriedades_healing: {
      ...
      espiritual:
        'Ancoramento espiritual, equilíbrio entre céu e terra, cura kármica.',
    },
  },
  ...
  8: {
    ...
    propriedades_healing: {
      fisico: 'Harmonização do campo áurico, elevação vibracional do corpo.',
      emocional: 'Abundância emocional, gratidão permanente, prosperidade mental.',
      espiritual:
        'Ativação da lei da abundância, manifestação da prosperidade cósmica.',
    },
  },
  ...
  13: {
    ...
    propriedades_healing: {
      ...
      espiritual:
        'Descobertura de dons ocultos, manifestação de tesouros internos.',
    },
  },
  ...
  15: {
    ...
    propriedades_healing: {
      fisico: 'Ativação da comunicação energética, alinhamento da linhagem física.',
  ...
  16: {
    ...
    propriedades_healing: {
      ...
      espiritual:
        'Orientação divina, revelação de destino, proteção na jornada.',
    },
  },
};
