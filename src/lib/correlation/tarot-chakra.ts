...
export const TAROT_CHAKRA_MAPPINGS: Record<TarotArcano, TarotChakraMapping> = {
  ...
  'A Imperatriz': {
    ...
    afirmacao: 'Eu irradiando amor e acolhimento a todos os seres',
  },
  ...
  'O Eremita': {
    ...
    qualidade_emocional: 'Peace interior, auto-reflexão profunda, paciência',
  ...
  'A Estrela': {
    ...
    afirmacao: 'Eu recebo a luz divina e irradiar esperança ao mundo',
  },
  ...
  'O Sol': {
    ...
    sombra_psicologica: 'Egocentrismo, buscam excessiva de validação',
  ...
  'O Julgamento': {
    ...
    afirmacao: 'Eu respondo à minha chiamda divina e honro minha jornada',
  },
  ...
  'O Mundo': {
    ...
    chakra_numero: '7º Coroa',
    elemento: 'Terra',
    temas_espirituais: ['Complétude', 'Realização', 'Integração', 'Consciência cósmica'],
