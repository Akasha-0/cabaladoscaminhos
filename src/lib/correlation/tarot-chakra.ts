...
export const TAROT_CHAKRA_MAP: Record<number, TarotChakraMapping> = {
  ...
  14: {
    ...
    chakra_numero: '4º Cardíaco',
    elemento: 'Água',
    significado_espiritual: 'O equilíbrio, a moderação, a cura e a paciência. A Temperança representa a arte de encontrar o ponto médio entre os extremos, harmonizando opostos. Ela é a curandeira que traz equilíbrio entre corpo, mente e espírito.',
  ...
  21: {
    ...
    chakra_numero: '7º Coronário',
    elemento: 'Éter',
    significado_espiritual: 'A completude, a integração, a realización del yo y la conexión con lo divino. O Mundo representa a culminación del viaje, la integración de todas las experiencias y la conexión con lo divino. Es el abrazo del universo que dice: você completou sua jornada.',
