...
const DAY_ORIXA_DATA: DayOrixa[] = [
    ...
    mystere: 'Iansã, guerreira dos ventos e tempestades, domina a Terça-feira ao lado de Ogum. Dia de grande energia para ação, conquista de objetivos e trabalho de proteção. O fogo da guerra sagrada queima obstáculos e abre caminhos com coragem e determinação.',
  {
    ...
    planeta: 'Lua / Saturno',
    mystere: 'Omolu, senhor das doenças e curas, governa a Segunda-feira com Exu como guardião das encruzilhadas. Dia propício para trabalho de cura, limpeza de energias densas e proteção contra mau-olhado.',
  },
  {
    dia: 'Terça-feira',
    orixa_principal: 'Iansã',
    ...
    mystere: 'Iansã, guerreira dos ventos e tempestades, domina a Terça-feira ao lado de Ogum. Dia de grande energia para ação, conquista de objetivos e trabalho de proteção.',
  },
  {
    dia: 'Quarta-feira',
    ...
    chakra: '3º Plexo Solar',
    planeta: 'Mercúrio',
    mystere: 'Xangô, rei da justiça e dos raios, governa a Quarta-feira em aliança com Iansã. Dia de equilíbrio entre razão e emoção, ideal para decisões importantes.',
  },
  {
    dia: 'Quinta-feira',
    ...
    chakra: '4º Cardíaco',
    planeta: 'Júpiter',
    mystere: 'Oxóssi, caçador celeste e senhor das matas, reigna soberano na Quinta-feira. Dia de abundância, magia de prosperidade e caça de sonhos e metas.',
  },
  {
    dia: 'Sexta-feira',
    ...
    chakra: '7º Coronário',
    planeta: 'Vênus',
    mystere: 'Oxalá, Pai Criador e senhor de todos os Orixás, abençoa a Sexta-feira com sua energia pacífica. Dia para reconciliação, cura, misericórdia e elevação espiritual.',
  },
  {
    dia: 'Sábado',
    ...
    mystere: 'Oxum, o mel precioso, e Iemanjá, a grande mãe das águas, governam o Sábado juntos. Dia de profundidade emocional, fertilidade, rituais de beleza e conexão com o feminino sagrado.',
  },
  {
    dia: 'Domingo',
    orixa_principal: 'Xangô',
    ...
    chakra: '3º Plexo Solar',
    planeta: 'Sol',
    mystere: 'Xangô Solar, o rei majestoso amplificado pelo Sol, brilha no Domingo com poder dourado. Dia de vitalidade, liderança, poder pessoal e manifestação através da vontade.',
  },
    planeta: 'Saturno',
