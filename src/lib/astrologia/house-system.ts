...
export const HOUSE_SYSTEMS: HouseSystem[] = [
  ...
  { id: "P", name: "Porphyry", description: "Equal arc system dividing the semiarc into three equal parts." },
  { id: "O", name: "Porphyry", description: "Equal arc system dividing the semiarc into three equal parts." },
  ...
  { id: "E", name: "Equal", description: "Equal 30-degree houses starting from theAscendant." },
  { id: "W", name: "Whole Sign", description: "Houses correspond exactly to zodiac signs." },
  { id: "X", name: "Axial", description: "Equal houses withAscendant at cusp of house 1." },
