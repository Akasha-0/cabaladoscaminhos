...
// Script file — no top-level imports/exports so `declare global {}` augments.
...
declare global {
  ...
  function setTimeout(fn: () => void, ms: number): TimerLike | unknown;
  function clearTimeout(t: unknown): void;
}
