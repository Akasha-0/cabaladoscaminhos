...
export interface KundaliniPracticeConfig {
...
export interface KundaliniPracticeResult {
  completed: boolean;
...
export async function performPractice(config: KundaliniPracticeConfig = {}): Promise<KundaliniPracticeResult> {
