...
import { Bell, Settings, Search, Sparkles, Moon, Sun, Calendar, Star, Zap } from 'lucide-react';
...
const MOON_PHASES = [
  { name: 'Lua Nova', symbol: '🌑' },
  { name: 'Crescente', symbol: '🌒' },
  { name: 'Quarto Crescente', symbol: '🌓' },
  { name: 'Gibosa', symbol: '🌔' },
  { name: 'Lua Cheia', symbol: '🌕' },
  { name: 'Minguante', symbol: '🌖' },
  { name: 'Quarto Minguante', symbol: '🌗' },
  { name: 'Balsâmica', symbol: '🌘' },
];
...
function getMoonPhase(): typeof MOON_PHASES[0] {
  const now = new Date();
  const startOfCycle = new Date(2024, 0, 6);
