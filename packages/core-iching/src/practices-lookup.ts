/**
 * @akasha/core-iching — Práticas Integrativas (lookup)
 * Helpers de busca sobre o banco `PRACTICES` (índice por id, agrupamentos por
 * elemento / tradição / categoria e filtros por área de vida).
 *
 * Mantido em arquivo separado para que `practices.ts` continue focado apenas
 * no banco de dados (catálogo de práticas), sem que as tabelas de lookup
 * inflem o módulo principal.
 */
