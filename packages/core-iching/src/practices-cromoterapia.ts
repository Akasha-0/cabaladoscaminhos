 ...
 *
 * Banco de práticas de terapia por luz/cor, associando cada cor a
 * elementos wu-xing, chakras, planetas e hexagramas.
 *
 * Extraído de `practices.ts` para reduzir o tamanho do módulo raiz e
 * tornar a evolução desta família (novas cores / afinações) localizada.
 */
import type { IntegrativePractice } from './types';

/** Práticas de Cromoterapia. 5 entradas: amarelo, azul, verde, vermelho, afirmação. */
