...
export function calcularAnoPessoal(dataNascimento: string): {
  numero: number;
  sefirot: string;
  descricao: DescricaoCiclo | null;
} {
...
export function calcularMesPessoal(anoPessoal: number): {
  numero: number;
  sefirot: string;
  descricao: DescricaoCiclo | null;
} {
...
export function calcularDiaPessoal(
  dataNascimento: string,
  anoPessoal: number
): { numero: number; sefirot: string; descricao: DescricaoCiclo | null } {
  const hoje = new Date();
