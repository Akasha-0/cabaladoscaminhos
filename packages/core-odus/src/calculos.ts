...
export const odusData: Record<number, OduInfo> = {
  ...
  3: {
    ...
    preceitos: ['Evitar brigas e discussões', 'Manter o foco no trabalho e na justiça', 'Não demandar contra os outros'],
  ...
  4: {
    ...
    preceitos: ['Desenvolver a intuição', 'Não ignorar avisos e sonhos', 'Cuidar da saúde do sangue e dos olhos'],
  ...
  5: {
    ...
    preceitos: ['Cuidar da autoestima', 'Usar perfumes', 'Manter a higiene espiritual', 'Buscar a diplomacia'],
    ebos: ['Ebó de Atração/Ouro: Banhos de mel, caldas de frutas, oferendas com girassóis e moedas douradas em águas doces']
  },
  6: {
    numero: 6,
    nome: 'Obará',
    ...
    preceitos: ['Ser generoso', 'Estudar', 'Manter a cabeça erguida', 'Praticar a gratidão para atrair a riqueza'],
    ebos: ['Ebó de Fartura: Oferecer seis tipos de frutas, amalá para Xangô, dar comida à terra e partilhar banquetes']
  },
  7: {
    numero: 7,
    nome: 'Odi',
    ...
    preceitos: ['Praticar o desapego', 'Aceitar as mudanças da vida', 'Não cavar o próprio buraco com mágoas'],
    ebos: ['Ebó de Transmutação: Pipoca (Deburu) para Omolu, banhos de lama ou argila, defumações pesadas com resinas']
  },
  8: {
    numero: 8,
    nome: 'EjiOníle',
    ...
    preceitos: ['Cuidar muito bem do próprio Ori (cabeça)', 'Buscar a paz', 'Evitar o orgulho e a arrogância'],
    ebos: ['Ebó de Alinhamento (Bori): Oferendas de canjica branca, algodão, banhos de boldo (tapete de Oxalá) e velas brancas']
  },
  9: {
    numero: 9,
    nome: 'Ossá',
    ...
    preceitos: ['Respeitar o poder feminino', 'Controlar a impulsividade e as palavras', 'Fluir com as mudanças'],
    ebos: ['Ebó de Limpeza Astral: Sacudimentos com folhas de fumo ou pinhão roxo, oferendas de acarajé para Iansã no vento']
  },
  10: {
    numero: 10,
    nome: 'Ofun',
    ...
    preceitos: ['Vestir-se de branco', 'Manter o silêncio e a quietude', 'Estudar a espiritualidade profunda'],
    ebos: ['Ebó de Alívio/Saúde: Tudo neste Odú pede rezas mansas, frutas brancas, banhos de leite de cabra ou ervas calmas']
  },
  11: {
    numero: 11,
    nome: 'Owarin',
    ...
    preceitos: ['Organizar a mente e a rotina', 'Canalizar a ansiedade em atividades físicas ou artísticas'],
    ebos: ['Ebó de Movimento: Rodar chaves, acender velas nas esquinas, banhos de ervas quentes (guiné, arruda)']
  },
  12: {
    numero: 12,
    nome: 'Ejilsebora',
    ...
    preceitos: ['Manter a integridade a todo custo', 'Não julgar os outros sem provas', 'Equilibrar a razão e a emoção'],
  ...
  13: {
    ...
    preceitos: ['Respeitar o tempo das coisas', 'Buscar a sabedoria dos mais velhos', 'Cuidar da saúde das articulações'],
  ...
  14: {
    ...
    quizilas: ['Falsidade', 'Maltratar animais (especialmente répteis)', 'Revelar segredos confiados'],
    preceitos: ['Manter a discrição absoluta sobre sua vida pessoal', 'Cultivar a flexibilidade perante os obstáculos'],
    ebos: ['Ebó de Renovação: Banhos com folhas de fortuna e dinheiro-em-penca, amarrar fitas coloridas (7 cores)']
  },
  15: {
    numero: 15,
    nome: 'Ogbogbé',
    ...
    preceitos: ['Buscar a paz no lar', 'Proteger a própria energia contra feitiçarias e inveja', 'Focar no amor próprio'],
  ...
  16: {
    ...
    quizilas: ['Dúvidar da própria espiritualidade', 'Orgulho', 'Arrogância', 'Não ouvir conselhos'],
    preceitos: ['Manter as práticas espirituais em dia', 'Compartilhar a sabedoria com quem precisa', 'Ser grato'],
    ebos: ['Ebó de Agradecimento: Flores brancas, oferendas de frutas doces e claras, acender lâmpadas ou muitas velas brancas']
  }
};
