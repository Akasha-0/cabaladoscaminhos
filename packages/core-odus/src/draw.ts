...
const oduMap: Record<
  number,
  { top: number; bottom: number; elementos: string; orixa: string; significado: string }
> = {
  1: {
    top: 1,
    bottom: 1,
  ...
  2: {
    ...
    elementos: 'Ar/Terra',
    orixa: 'Ibeji',
    significado: 'A dualidade, os caminhos duplos, uniao e disputa. Vitoria apos grandes lutas.',
  },
  3: {
    top: 1,
    bottom: 3,
    ...
    orixa: 'Ogum',
    significado: 'A revolta, a forca fisica, a criacao de ferramentas. O corte e a separacao.',
  },
  4: {
    top: 1,
    bottom: 4,
    elementos: 'Fogo/Terra',
    orixa: 'Iemanja',
    significado: 'O aviso, o sangue que corre nas veias, a visao espiritual. Olhar para o futuro.',
  },
  5: {
    top: 1,
    bottom: 5,
  ...
  9: {
    ...
    elementos: 'Ar/Agua',
    orixa: 'Iansa',
    significado: 'O vento, as transformacoes rapidas, o reino das Iyami (as bruxas ancestrais).',
  },
  10: {
    top: 2,
    bottom: 2,
    elementos: 'Ar/Agua',
    orixa: 'Oxala',
    significado: 'O misterio, a velhice, a cura, o sopro divino. O Odu mais velho da criacao.',
  },
  11: {
    top: 2,
    bottom: 3,
    elementos: 'Fogo/Ar',
    orixa: 'Iansa',
    significado: 'A pressa, a ansiedade, a mudanca de rumo rapida. O vento que espalha as folhas.',
  },
  12: {
    top: 2,
    bottom: 4,
