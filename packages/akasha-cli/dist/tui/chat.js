...
import { createChatScreen } from './interface.js';
import { createOutputRenderer } from './output.js';
...
export class ChatSession {
    ...
    async getMentorResponse(_question) {
...
`;
    ...
    // ─── Helpers ────────────────────────────────────────────────────────────────
    updateTokenUsage(responseLength) {
...
export async function runChat(config) {
