...
const headingVariants = cva('font-semibold tracking-tight', {
  variants: {
    variant: {
      ...
      mystical: ['font-cinzel', 'font-medium', 'tracking-[0.15em]', 'uppercase', 'text-foreground'],
...
export interface BodyTextProps
  extends VariantProps<typeof bodyTextVariants>, React.HTMLAttributes<HTMLParagraphElement> {}

const BodyText = forwardRef<HTMLParagraphElement, BodyTextProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <p ref={ref} className={cn(bodyTextVariants({ variant, size }), className)} {...props} />
    );
  }
);
  ...
  ({ className, variant, orixaName, style, ...props }, ref) => {
    ...
    return (
      <label
        ...
        style={isOrixaVariant && borderColor ? { ...style, borderLeftColor: borderColor } : style}
        {...props}
      />
    );
  }
