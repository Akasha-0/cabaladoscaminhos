      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, width: '100%' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {sintese.descricao && (
            ...
            >
              {sintese.descricao}
              {!aberto && <span style={{ color: 'rgba(124,92,255,0.5)' }}> · {hintTexto}</span>}
            </p>
          )}
        </div>
      </div>
                ...
                >
                  {(() => {
                    ...
                    const map: Record<string, string> = {
                      saude:
                        'Na Saúde & Vitalidade: sua energia hoje vem de donde? Cuide do corpo com presença — não como tarefa.',
                      trabalho:
                        'No Trabalho & Prosperidade: esta decisão reflete sua vocação ou apenas sua necessidade de aprovação? Aja desde o propósito.',
                      amor: 'No Amor & Relacionamentos: este vínculo nutre sua alma ou alimenta sua carência? Escolha profundidade.',
                      criacao:
                        'Na Criação & Expressão: sua arte vem de uma fome interior ou do medo de não ser visto? Crie desde o silêncio.',
                      proposito:
                        'No Propósito & Destino: esta escolha aproxima você de quem veio ser? Confie no caminho — não na validação.',
                      familia:
                        'Na Família & Ancestralidade: esta dinâmica repete um padrão antigo ou já é sua escolha adulta? Liberdade inclui dizer não.',
                      espiritualidade:
                        'Na Espiritualidade & Transcendência: esta prática ancora você no presente ou foge dele? O divino habita na simplicidade.',
                      superacao:
                        'Na Superação & Desafios: o que te desafia hoje é um mestre ou um espelho? Ambos pedem a mesma coisa: presença.',
                    };
                    return (
                      map[id] ??
                      'Antes de decidir nesta área: pergunte — isso vem da sua paz interior ou da sua ansiedade? Se ansiedade, espere. Se paz, aja.'
                    );
                  })()}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  {sintese.contribuicoes.map((c) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          style={{ fontSize: '0.75rem', fontWeight: 600, color: cor, minWidth: 72 }}
                        >
                          {nomePilar}
                        </span>
                        <span
