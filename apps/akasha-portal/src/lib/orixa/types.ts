...
export const ORIXAS_UNIFIED: Record<string, OrixaCore> = {
  ...
  'exu': {
    ...
    numerosSagrados: [3, 7],
    diaSemana: 'Segunda-feira',
    qualidade: 'Comunicação, Caminhos, Mutabilidade',
    desafio: 'Manipulação',
  ...
  'iansan': {
    ...
    numerosSagrados: [4, 9],
    diaSemana: 'Quarta-feira',
    qualidade: 'Tempestade, Vitória, Movimentação',
    desafio: 'Impaciência',
  ...
  'yemoja': {
    ...
    numerosSagrados: [2, 9],
    diaSemana: 'Sábado',
    qualidade: 'Maternidade, Intuição',
  ...
  'obaluaiê': {
    ...
    cores: ['Roxo', 'Branco'],
    chakraPrincipal: 3,
    numerosSagrados: [8, 13],
    diaSemana: 'Segunda-feira',
    qualidade: 'Saúde, Regeneração, Poxás',
    desafio: 'Medo da morte',
    archetype: 'O Senhor das Doenças e da Cura',
  },
  'xapanã': {
    ...
    numerosSagrados: [8, 9],
    diaSemana: 'Segunda-feira',
    qualidade: 'Varíola, Doenças, Respeito aos mais velhos',
    desafio: 'Preconceito',
  ...
  'ejiokô': {
    ...
    numerosSagrados: [2, 4],
    diaSemana: 'Sábado',
    qualidade: 'Duas cabeças, Dupla visão',
    desafio: 'Indecisão',
  ...
  'pombagira': {
    ...
    saudacao: 'Salve a Rainha!',
    planeta: 'Vênus',
    elemento: 'Fogo',
    cores: ['Rosa', 'Vermelho', 'Preto'],
    chakraPrincipal: 4,
    numerosSagrados: [3, 7, 13],
    diaSemana: 'Sexta-feira',
    qualidade: 'Amor, Luxúria, Magia Sexual',
    desafio: 'Obsessão',
  ...
  'aroeira': {
    ...
    numerosSagrados: [5, 8],
    diaSemana: 'Terça-feira',
    qualidade: 'Proteção, Limpeza, Sabão',
    desafio: 'Rigidez',
