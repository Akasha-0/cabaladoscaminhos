...
export const FREQUENCY_ODU_MAP: Record<number, FrequencyOduMapping> = {
  ...
  852: {
    ...
    aplicacao_healing: {
      ...
      pratica_recomendada: 'Meditação profunda, trabalho com terceiro olho, rituais de revelação de mistérios',
    },
    orixa: 'Omolu',
    chakra: '6º Frontal (Ajna)',
  ...
  963: {
    ...
    aplicacao_healing: {
      ...
      pratica_recomendada: 'Sagramento, oração silenciosa, contemplação pura, rituais de paz absoluta',
    },
    orixa: 'Oxumaré',
