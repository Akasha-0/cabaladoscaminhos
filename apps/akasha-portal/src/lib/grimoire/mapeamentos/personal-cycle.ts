...
export const PINNACLE_THEMES: Record<number, PinnacleEntry> = {
  1: {
    ...
    fonte: 'Cabalística clássica — número 1 = Sol, identidade, pioneirismo. Pináculo 1 = ciclo deestablishing self as separate from family of origin.',
  },
  2: {
    ...
    fonte: 'Cabalística clássica — número 2 = Lua, dualidade, receptividade. Pináculo 2 = ciclo de learning to relate as equal partner.',
  },
  3: {
    ...
    fonte: 'Cabalística clássica — número 3 = Júpiter, expansão, expressão. Pináculo 3 = ciclo de creative self-expression and social engagement.',
  },
  4: {
    ...
    fonte: 'Cabalística clássica — número 4 = Urano/Raiz, estrutura, esforço. Pináculo 4 = ciclo de building practical foundations for security.',
  },
  5: {
    ...
    fonte: 'Cabalística clássica — número 5 = Mercúrio, movimento, liberdade. Pináculo 5 = ciclo of liberation from previous structure, often through travel or upheaval.',
  },
  6: {
    ...
    fonte: 'Cabalística clássica — número 6 = Vênus, amor, harmonia. Pináculo 6 = ciclo of balancing love, responsibility, and creative service.',
  },
  7: {
    ...
    fonte: 'Cabalística clássica — número 7 = Netuno/Selene, introspecção, fé. Pináculo 7 = ciclo de withdrawal from outer world to develop inner wisdom.',
  },
  8: {
    ...
    fonte: 'Cabalística clássica — número 8 = Saturno, poder, matéria. Pináculo 8 = ciclo de materializing power and proving self through achievement.',
  },
  9: {
    ...
    fonte: 'Cabalística clássica — número 9 = Marte, completude, compaixão. Pináculo 9 = ciclo de completing a 9-year cycle, letting go, humanitarian service.',
  },
};
...
export const CHALLENGE_DESCRIPTIONS: Record<number, ChallengeEntry> = {
  0: {
    ...
    fonte: 'Número 0 em numerologia cabalística = potencial virgem, mestre número oculto. Ausência de desafio = aparente facilidade que esconde falta de esforço. Refere-se à need to develop discipline where natural talent creates illusion of effortlessness.',
  },
  1: {
    ...
    fonte: 'Cabalística — número 1 = Sol, ego, vontade. Desafio 1 = difficulty developing healthy independence without becoming self-absorbed or domineering.',
  },
  2: {
    ...
    fonte: 'Cabalística — número 2 = Lua, receptividade, yin. Desafio 2 = hypersensitivity creating tendency to avoid confrontation or manipulate indirectly.',
  },
  3: {
    ...
    fonte: 'Cabalística — número 3 = Júpiter, expressão, expansão. Desafio 3 = scattered creative energy that starts many things but finishes few — dispersion as defense against depth.',
  },
  4: {
    ...
    fonte: 'Cabalística — número 4 = Urano/Raiz, estrutura, inércia. Desafio 4 = rigidity and fear of change that manifests as stubbornness or excessive materialism.',
  },
  5: {
    description: 'Impulsividade, excessos e instabilidade',
    howToOvercome: 'Disciplina, rotina, moderação',
    lifeArea: 'Estabilidade',
    fonte: 'Cabalística — número 5 = Mercúrio, movimento, mudança. Desafio 5 = excess and impulsivity that uses change as escape from internal work; difficulty with routine.',
  },
  6: {
    ...
    fonte: 'Cabalística — número 6 = Vênus, harmonia, serviço. Desafio 6 = tendência a assumir responsabilidade pelos outros ou pelo mundo, criandomart via perfectionism and controlling love.',
  },
  7: {
    ...
    fonte: 'Cabalística — número 7 = Netuno/Selene, introspecção, fé. Desafio 7 = over-analysis that leads to spiritual skepticism, isolation, and difficulty trusting others or the universe.',
  },
  8: {
    ...
    fonte: 'Cabalística — número 8 = Saturno, poder, matéria. Desafio 8 = driven by fear of lack, manifesting as workaholism, materialism, or abuse of power for personal gain.',
  },
  9: {
    ...
    fonte: 'Cabalística — número 9 = Marte, completude, compaixão. Desafio 9 = difficulty letting go of past hurts, self-judgment, and the temptation to dwell in victimhood rather than claim personal power.',
  },
};
...
export const KARMIC_LESSON_DESCRIPTIONS: Record<number, KarmicLessonEntry> = {
  1: {
    ...
    lifeArea: 'Autonomia',
    fonte: 'Cabalística — número 1 = Sol, vontade, self. Lição cármica 1 = números ausentes no mapa indicam lições que a alma chose before birth to work on in this lifetime.',
  },
  2: {
    description: 'Lição de paciência, diplomacia e cooperação',
    howToLearn: 'Medite sobre timing, cultive parcerias, espere',
    lifeArea: 'Relacionamentos',
    fonte: 'Cabalística — número 2 = Lua, receptividade, dualidade. Lição cármica 2 = aprender a cooperar sem perder a própria voz.',
  },
  3: {
    description: 'Lição de expressão, criatividade e comunicação',
    howToLearn: 'Escreva, fale, cante, dance — se expresse!',
    lifeArea: 'Comunicação',
    fonte: 'Cabalística — número 3 = Júpiter, expressão, expansão. Lição cármica 3 = superar inibição criativa e medo de se expressar.',
  },
  4: {
    description: 'Lição de disciplina, estrutura e trabalho árduo',
    howToLearn: 'Construa rotinas, persevere, honre o processo',
    lifeArea: 'Trabalho',
    fonte: 'Cabalística — número 4 = Urano/Raiz, sistema, effort. Lição cármica 4 = desenvolver paciência com o processo e disciplina sem rigidez paralizante.',
  },
  5: {
    description: 'Lição de liberdade, mudança e adaptação',
    howToLearn: 'Viaje, experimente, rompa zonas de conforto',
    lifeArea: 'Liberdade',
    fonte: 'Cabalística — número 5 = Mercúrio, liberdade, movimento. Lição cármica 5 = superar medos de mudança e abraçar a liberdade com responsabilidade.',
  },
  6: {
    ...
    fonte: 'Cabalística — número 6 = Vênus, harmonia, serviço. Lição cármica 6 = aprender a amar sem controlar e servir sem se sacrificar.',
  },
  7: {
    ...
    fonte: 'Cabalística — número 7 = Netuno/Selene, fé, conhecimento interior. Lição cármica 7 = desenvolver confiança na sabedoria interior e na ordem invisível do universo.',
  },
  8: {
    description: 'Lição de poder, abundância e manifestação',
    howToLearn: 'Desenvolva valor próprio, gerencie recursos',
    lifeArea: 'Abundância',
    fonte: 'Cabalística — número 8 = Saturno, poder, manifestação. Lição cármica 8 = superar medo de abundancia e desenvolverautoridade interna sobre recursos próprios.',
  },
  9: {
    ...
    fonte: 'Cabalística — número 9 = Marte, compaixão, completude. Lição cármica 9 = soltar attachedamentos e desenvolver compaixão que transcende o ego.',
  },
};
...
export const MATURITY_THEMES: Record<number, MaturityEntry> = {
  1: {
    ...
    fonte: 'Número de maturidade 1 = synthesis of life path + expression number. Represents how the person will manifest their adult authority.',
  },
  2: {
    ...
    fonte: 'Número de maturidade 2 = synthesis that emphasizes receptivity and partnership in the second half of life.',
  },
  3: {
    ...
    fonte: 'Número de maturidade 3 = expression of creative gifts through teaching, art, or communication in later life.',
  },
  4: {
    ...
    fonte: 'Número de maturidade 4 = consolidation phase where previous exploration is built into lasting structure.',
  },
  5: {
    ...
    fonte: 'Número de maturidade 5 = liberation from constraints built in the 4 cycle; wisdom earned through change.',
  },
  6: {
    theme: 'Amor maduro',
    ...
    challenges: ['Sacrifício', 'Controle', 'Perfeccionismo'],
    fonte: 'Número de maturidade 6 = responsibility arc — to home, community, and those in one\'s care.',
  },
  7: {
    ...
    fonte: 'Número de maturidade 7 = withdrawal from outer achievement to deepen inner life; teaching through being.',
  },
  8: {
    theme: 'Poder maduro',
    ...
    fonte: 'Número de maturidade 8 = mastery over material world; spiritualization of power rather than abuse of it.',
  },
  9: {
    ...
    fonte: 'Número de maturidade 9 = completion arc; sharing accumulated wisdom through service and letting go.',
  },
  11: {
    ...
    fonte: 'Número mestre 11 = double-digit master number. Higher octave of 2. Represents spiritual leadership and illumination.',
  },
  22: {
    ...
    fonte: 'Número mestre 22 = double-digit master number. Higher octave of 4. Master Builder — turning visionary dreams into concrete reality for collective benefit.',
  },
  33: {
    ...
    fonte: 'Número mestre 33 = triple-digit master number. Higher octave of 6. Master Teacher — spiritualized service that can bridge heaven and earth through unconditional love.',
  },
};
