 ...
 *
 * Wave 17.3: arquivo restaurado após regressão Wave 12.5. Estava
 * removido como "dead code" no Wave 11.5 (commit 9f2200a1), mas
 * rate-limit-strict.ts (Wave 12.5) importa `hashIp()` ativamente.
 */
