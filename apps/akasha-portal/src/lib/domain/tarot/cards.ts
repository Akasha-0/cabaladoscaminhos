...
const WANDS: TarotCard[] = [
  {
    ...
    number: 1,
    element: 'Fire',
    upright: ['New venture', 'Inspiration', 'Creation', 'Renewal'],
  ...
  },
  {
    ...
    number: 2,
    element: 'Fire',
    upright: ['Future planning', 'Personal power', 'Discovery', 'Progress'],
    reversed: ['Playing it safe', 'Fear of unknown', 'Lack of planning'],
  },
  {
    id: 24,
    name: 'Three of Wands',
    ...
    number: 3,
    element: 'Fire',
    upright: ['Progress', 'Forward motion', 'Revealing plans', 'Foresight'],
    reversed: ['Playing it safe', 'Obstacles', 'Delays', 'Frustration'],
  },
  {
    id: 25,
    name: 'Four of Wands',
  ...
  },
  {
    ...
    number: 5,
    element: 'Fire',
    upright: ['Conflict', 'Disagreement', 'Competition', 'Winning'],
  ...
  },
  {
    ...
    reversed: ['Inner success', 'Fall from grace', 'Ego', 'Arrogance'],
  },
  {
    id: 28,
    name: 'Seven of Wands',
    ...
    reversed: ['Exhaustion', 'Giving up', 'Paranoia', 'Victim mentality'],
  },
  {
    id: 29,
    name: 'Eight of Wands',
    ...
    number: 8,
    element: 'Fire',
    upright: ['Action', 'Movement', 'Fast paced change', 'Swift energy'],
    reversed: ['Delays', 'Frustration', 'Waiting', 'Hesitation'],
  },
  {
    id: 30,
    name: 'Nine of Wands',
    ...
    reversed: ['Exhaustion', 'Paranoia', 'Victim mentality', 'Breaking point'],
  },
  {
    id: 31,
    name: 'Ten of Wands',
    ...
    reversed: ['Doing it all', 'Delegation', 'Release of burden', 'Burnout'],
  },
  {
    id: 32,
    name: 'Page of Wands',
    ...
    reversed: ['Newly found passion', 'Self-limiting beliefs', 'Setbacks'],
  },
  {
    id: 33,
    ...
    reversed: ['Passion project', 'Impulsive', 'Passionate', 'Scattered energy'],
  },
  {
    id: 34,
    name: 'Queen of Wands',
    ...
    number: 13,
    element: 'Fire',
    upright: ['Courage', 'Confidence', 'Independence', 'Warmth'],
    reversed: ['Self-assured', 'Self-preserving', 'Jealousy', 'Insecurity'],
  },
  {
    id: 35,
    name: 'King of Wands',
    ...
    number: 14,
    element: 'Fire',
    upright: ['Natural leader', 'Vision', 'Success', 'Boldness'],
    reversed: ['Impulsiveness', 'Tyranny', 'Fragile ego', 'Rash decisions'],
  },
];
...
const CUPS: TarotCard[] = [
  {
    ...
    number: 1,
    element: 'Water',
    upright: ['New love', 'Compassion', 'Creativity', 'Intuition'],
    reversed: ['Emotional loss', 'Blocked emotions', 'Repressed feelings'],
  },
  {
    id: 37,
    name: 'Two of Cups',
  ...
  },
  {
    ...
    number: 3,
    element: 'Water',
    upright: ['Celebration', 'Friendship', 'Community', 'Creativity'],
    reversed: ['Independence', 'Social anxiety', 'Third party'],
  },
  {
    id: 39,
    name: 'Four of Cups',
  ...
  },
  {
    ...
    number: 5,
    element: 'Water',
    upright: ['Regret', 'Failure', 'Disappointment', 'Grief'],
    reversed: ['Personal setbacks', 'Moving on', 'Self-forgiveness'],
  },
  {
    id: 41,
    name: 'Six of Cups',
    ...
    reversed: ['Living in the past', 'Naivety', 'Stagnation'],
  },
  {
    id: 42,
    name: 'Seven of Cups',
    ...
    number: 7,
    element: 'Water',
    upright: ['Opportunities', 'Choices', 'Wishful thinking', 'Fantasy'],
    reversed: ['Alignment', 'Personal values', 'Reevaluation'],
  },
  {
    id: 43,
    name: 'Eight of Cups',
    ...
    reversed: ['Trying one more time', 'Forgiveness', 'Setting boundaries'],
  },
  {
    id: 44,
    name: 'Nine of Cups',
    ...
    reversed: ['Inner happiness', 'Materialism', 'Satisfaction', 'Greed'],
  },
  {
    id: 45,
    name: 'Ten of Cups',
    ...
    reversed: ['Disalignment', 'Unfulfilled dreams', 'Mediocrity'],
  },
  {
    id: 46,
    name: 'Page of Cups',
    ...
    number: 11,
    element: 'Water',
    upright: ['Creative opportunity', 'Intuition', 'Curiosity', 'Exploration'],
    reversed: ['Inner child healing', 'Emotional immaturity', 'Creative blocks'],
  },
  {
    id: 47,
    name: 'Knight of Cups',
    ...
    reversed: ['Overactive imagination', 'Moodiness', 'Unrealistic', 'Boredom'],
  },
  {
    id: 48,
    name: 'Queen of Cups',
    ...
    reversed: ['Inner feelings', 'Self-care', 'Clarity', 'Self-love'],
  },
  {
    id: 49,
    name: 'King of Cups',
    ...
    number: 14,
    element: 'Water',
    upright: ['Emotionally balanced', 'Diplomacy', 'Compassion', 'Receptive'],
    reversed: ['Self-compassion', 'Inner feelings', 'Moodiness', 'Coldness'],
  },
];
...
const SWORDS: TarotCard[] = [
  {
    ...
    number: 1,
    element: 'Air',
    upright: ['Breakthroughs', 'Clarity', 'Mental clarity', 'Truth'],
  ...
  },
  {
    ...
    number: 2,
    element: 'Air',
    upright: ['Difficult choices', 'Indecision', 'Stalemate', 'Avoidance'],
  ...
  },
  {
    ...
    number: 3,
    element: 'Air',
    upright: ['Heartbreak', 'Emotional pain', 'Grief', 'Sorrow'],
  ...
  },
  {
    ...
    reversed: ['Restlessness', 'Burnout', 'Slowing down', 'Too much rest'],
  },
  {
    id: 54,
    name: 'Five of Swords',
  ...
  },
  {
    ...
    number: 6,
    element: 'Air',
    upright: ['Transition', 'Leaving behind', 'Moving on', 'Departure'],
    reversed: ['Stuck', 'Resisting change', 'Unfinished business'],
  },
  {
    id: 56,
    ...
    number: 7,
    element: 'Air',
    upright: ['Betrayal', 'Deception', 'Getting away with something', 'Secrets'],
    reversed: ['Imposter syndrome', 'Self-deception', 'Truth revealed'],
  },
  {
    id: 57,
    ...
    number: 8,
    element: 'Air',
    upright: ['Imprisonment', 'Entrapment', 'Self-victimization', 'Helplessness'],
    reversed: ['New perspective', 'Released from prison', 'Freeing yourself'],
  },
  {
    id: 58,
    name: 'Nine of Swords',
    ...
    reversed: ['Inner turmoil', 'Trauma', 'Deep-seated issues', 'Releasing pain'],
  },
  {
    id: 59,
    name: 'Ten of Swords',
    ...
    number: 10,
    element: 'Air',
    upright: ['Painful ending', 'Crisis', 'Betrayal', 'Loss'],
    reversed: ['Recovery', 'Regeneration', 'Resistance to endings'],
  },
  {
    id: 60,
    name: 'Page of Swords',
    ...
    reversed: ['Self-expression', 'All talk no action', 'Deception'],
  },
  {
    id: 61,
    ...
    number: 12,
    element: 'Air',
    upright: ['Ambitious action', 'Drive', 'Fast thinking', 'Power'],
    reversed: ['Restlessness', 'Impatience', 'Unfocused', 'Forceful'],
  },
  {
    id: 62,
    ...
    number: 13,
    element: 'Air',
    upright: ['Independent', 'Truthful', 'Direct', 'Boundaries'],
    reversed: ['Overly emotional', 'Cold-hearted', 'Cruel', 'Bitterness'],
  },
  {
    id: 63,
    name: 'King of Swords',
    ...
    reversed: ['Inner truth', 'Inner voice', 'Manipulation', 'Tyranny'],
  },
];
...
const PENTACLES: TarotCard[] = [
  {
    ...
    number: 1,
    element: 'Earth',
    upright: ['New financial opportunity', 'Prosperity', 'Manifestation'],
    reversed: ['Lost opportunity', 'Missed chance', 'Poor financial planning'],
  },
  {
    id: 65,
    ...
    number: 2,
    element: 'Earth',
    upright: ['Multiple priorities', 'Time management', 'Stress', 'Adaptability'],
    reversed: ['Over-committed', 'Overwhelm', 'Re-prioritization'],
  },
  {
    id: 66,
    ...
    reversed: ['Disharmony', 'Miscommunication', 'Working alone'],
  },
  {
    id: 67,
    ...
    number: 4,
    element: 'Earth',
    upright: ['Saving money', 'Security', 'Control', 'Stability'],
    reversed: ['Over-spending', 'Greed', 'Materialism', 'Letting go'],
  },
  {
    id: 68,
    ...
    number: 5,
    element: 'Earth',
    upright: ['Financial loss', 'Poverty', 'Lack', 'Isolation'],
    reversed: ['Recovery from loss', 'Spiritual poverty', 'Finding help'],
  },
  {
    id: 69,
    ...
    number: 6,
    element: 'Earth',
    upright: ['Giving and receiving', 'Sharing wealth', 'Generosity', 'Charity'],
    reversed: ['Debt', 'Strings attached', 'Inequality', 'Self-care'],
  },
  {
    id: 70,
    ...
    reversed: ['Frustration', 'Impatience', 'Lack of long-term vision'],
  },
  {
    id: 71,
    ...
    number: 8,
    element: 'Earth',
    upright: ['Apprenticeship', ' repetitive tasks', ' mastery', 'dedication'],
    reversed: ['Self-development', 'Over-skill', 'Machinery', 'Perfectionism'],
  },
  {
    id: 72,
    ...
    reversed: ['Self-worth', 'Over-investment in work', 'Superficiality'],
  },
  {
    id: 73,
  ...
  },
  {
    ...
    reversed: ['Lack of progress', 'Procrastination', 'Missed chances'],
  },
  {
    id: 75,
    ...
    reversed: ['Self-discipline', 'Boredom', 'Feeling stuck', 'Obsessive work ethic'],
  },
  {
    id: 76,
    ...
    number: 13,
    element: 'Earth',
    upright: ['Nurturing', 'Practicality', 'Security', 'Abundance'],
    reversed: ['Self-care', 'Financial independence', 'Work-home conflict'],
  },
  {
    id: 77,
    ...
    reversed: ['Financially inept', 'Stubborn', 'Greedy', 'Materialistic'],
  },
];
