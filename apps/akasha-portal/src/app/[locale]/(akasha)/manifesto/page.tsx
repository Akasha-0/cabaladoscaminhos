    ...
    >
      ...
      {incomplete && (
        ...
        >
          ...
          >
            Seu mapa está incompleto — alguns dados podem ser genéricos. Complete seu onboarding
      ...
      <div style={{ maxWidth: 700, width: '100%' }}>
        ...
        <div style={glass}>
          <div style={sectionTitleStyle('#F0B429')}>
            ...
            <ExpandToggle
              expanded={expandedOdu}
              onToggle={() => setExpandedOdu(!expandedOdu)}
              color="#F0B429"
            />
          </div>
          ...
          {odus.orixas.length > 0 && <DataPair label="Orixás" value={odus.orixas.join(' · ')} />}
        ...
        <div style={glass}>
          <div style={sectionTitleStyle('#7C5CFF')}>
            ...
            <ExpandToggle
              expanded={expandedKabala}
              onToggle={() => setExpandedKabala(!expandedKabala)}
              color="#7C5CFF"
            />
          </div>
        ...
        <div style={glass}>
          <div style={sectionTitleStyle('#2DD4BF')}>
            ...
            <ExpandToggle
              expanded={expandedTantra}
              onToggle={() => setExpandedTantra(!expandedTantra)}
              color="#2DD4BF"
            />
          </div>
        ...
        <div style={glass}>
          <div style={sectionTitleStyle('#7C5CFF')}>
            ...
            <ExpandToggle
              expanded={expandedAstro}
              onToggle={() => setExpandedAstro(!expandedAstro)}
              color="#7C5CFF"
            />
          </div>
