(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (a) => {
    'use strict';
    let e = (0, a.i(6927).default)('sparkles', [
      [
        'path',
        {
  ...
  (a) => {
    ...
    let e = [
        ...
        },
        {
          ...
          tradition: 'Cromoterapia',
          category: 'cromoterapia',
          associations: { color: 'branco', chakra: 7, hexagrams: [1, 30] },
        ...
        },
        {
          ...
          howTo:
            'Macere folhas de Nanã com água de coco verde. Banho de chuveiro da cintura para baixo.',
        ...
        },
        {
          ...
          frequency:
            'Antes de práticas espirituais ou quando sentir necessidade de proteção energética.',
          isSafe: !0,
        },
        {
          id: 'oleo-ylang-ylang',
        ...
        },
        {
          ...
          howTo:
            'Queime ramos de alecrim seco e passe a fumaça pela cabeça, evitando olhos e boca.',
      ...
      o = Object.fromEntries(e.map((a) => [a.id, a])),
      r = {};
    for (let a of e) {
      let e = a.associations.element;
      e && (r[e] || (r[e] = []), r[e].push(a));
    }
    let i = {};
    for (let a of e) (i[a.tradition] || (i[a.tradition] = []), i[a.tradition].push(a));
    let s = {};
    for (let a of e) (s[a.category] || (s[a.category] = []), s[a.category].push(a));
    a.s([
      'PRACTICES',
      0,
      e,
      ...
      0,
      function (a) {
        let o = a.toLowerCase().trim();
        return e.filter((a) => a.lifeAreas.some((a) => a.toLowerCase().includes(o)));
      },
  ...
  (a) => {
    a.v((e) =>
      Promise.all(['static/chunks/0zqd7q2tn.n2e.js'].map((e) => a.l(e))).then(() => e(51282))
    );
  },
  68559,
  (a) => {
    a.v((e) =>
      Promise.all(['static/chunks/14imo.y0a~q-g.js'].map((e) => a.l(e))).then(() => e(77634))
    );
  },
  80922,
  (a) => {
    a.v((e) =>
      Promise.all(['static/chunks/15_saz_l~g0er.js'].map((e) => a.l(e))).then(() => e(69203))
    );
  },
  58940,
  (a) => {
    a.v((e) =>
      Promise.all(['static/chunks/0kolt6ix3hrq1.js'].map((e) => a.l(e))).then(() => e(90009))
    );
  },
  72664,
  (a) => {
    a.v((e) =>
      Promise.all(['static/chunks/0dhfg7cae_2j4.js'].map((e) => a.l(e))).then(() => e(17736))
    );
  },
  67306,
  (a) => {
    a.v((e) =>
      Promise.all(['static/chunks/0jflbos_tyyx3.js'].map((e) => a.l(e))).then(() => e(70900))
    );
  },
]);
