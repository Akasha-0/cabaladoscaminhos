(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (a) => {
    'use strict';
    let e = (0, a.i(6927).default)('trending-up', [
      ['path', { d: 'M16 7h6v6', key: 'box55l' }],
      ['path', { d: 'm22 7-8.5 8.5-5-5L2 17', key: '1t1m79' }],
    ]);
    a.s(['TrendingUp', 0, e], 97275);
  },
  53723,
  21694,
  (a) => {
  ...
  (a) => {
    ...
    a.s(['Brain', 0, o], 61560);
    let i = (0, e.default)('triangle-alert', [
      [
        'path',
        {
    ...
    a.s(['AlertTriangle', 0, i], 63825);
    let r = (0, e.default)('chevron-down', [['path', { d: 'm6 9 6 6 6-6', key: 'qrunsl' }]]);
    a.s(['ChevronDown', 0, r], 55107);
  },
  38430,
  53443,
  (a) => {
    'use strict';
    var e = a.i(6927);
    let o = (0, e.default)('circle-check', [
      ['circle', { cx: '12', cy: '12', r: '10', key: '1mglay' }],
      ['path', { d: 'm9 12 2 2 4-4', key: 'dzmm74' }],
    ]);
    a.s(['CheckCircle2', 0, o], 38430);
    let i = (0, e.default)('circle-x', [
      ['circle', { cx: '12', cy: '12', r: '10', key: '1mglay' }],
      ['path', { d: 'm15 9-6 6', key: '1uzhvr' }],
      ['path', { d: 'm9 9 6 6', key: 'z0biqf' }],
    ]);
    a.s(['XCircle', 0, i], 53443);
  },
  86726,
  (a) => {
    'use strict';
    let e = (0, a.i(6927).default)('star', [
      [
        'path',
        {
  ...
  (a) => {
    'use strict';
    let e = (0, a.i(6927).default)('arrow-right', [
      ['path', { d: 'M5 12h14', key: '1ays0h' }],
      ['path', { d: 'm12 5 7 7-7 7', key: 'xquz4c' }],
    ]);
    a.s(['ArrowRight', 0, e], 28113);
  },
  92188,
  (a) => {
    'use strict';
      ...
      return {
        ...
        ...{
          ...
          astrologia: {
            ...
            pratica:
              'Leia 1 trânsito do dia. Não como previsão — como convite. O que ele ativa em você?',
            conexao:
          ...
          tantrica: {
            ...
            missao:
              'Sinta o que está vivo. Cada corpo fala. Você tem 11 canais — use mais do que 1.',
            sombra:
              'Viver só no corpo 5 (físico), achar que "corpo sutil" é metáfora e não prática.',
            pratica:
          ...
          odu: {
            ...
            conexao:
              'O Pilar 4 (Odu) é ANCESTRALIDADE — o que veio antes e sustenta o que está aqui.',
          ...
          iching: {
            ...
            sombra:
              'Viver consultando 100x por dia, viciar a leitura, substituir ação por consulta.',
            pratica:
    ...
    let o = [
      {
        ...
        titulo: 'Pioneiro',
        essencia:
          'Liderar pelo exemplo. Iniciar caminhos onde não há trilha, com coragem solitária.',
      ...
      },
      {
        ...
        missao:
          'Mostre algo seu. Diário, voz, desenho, dança — o canal importa menos que a verdade.',
        sombra: 'Dispersão, superficialidade, medo de ser profundo.',
        pratica:
          'Crie 1 coisa em 3 minutos sem editar. Foto, frase, rabisco. Não mostre a ninguém.',
      ...
      },
      {
        ...
        titulo: 'Construtor',
        essencia:
          'Estruturar. Onde outros improvisam, você ergue o alicerce. Paciência é sua oração.',
      ...
      },
      {
        ...
        titulo: 'Buscador',
        essencia:
          'Investigar. Ir para dentro. Perguntar antes de responder. Sua casa é o silêncio.',
      ...
      },
      {
        ...
        essencia:
          'Canal entre planos. Intuição aguda, visão, inspiração. Você sente antes de saber.',
      ...
      ...Array.from({ length: 9 }, (a, e) => {
        ...
        return {
          ...
          conexao:
            'O dom do dia complementa o Caminho de Vida — o dom é o dom; o caminho é a travessia.',
      ...
      ...Array.from({ length: 9 }, (a, e) => {
        ...
        return {
          ...
          pratica:
            'Observe 1 momento em que agiu no piloto automático. Como seria no seu estilo real?',
      ...
      ...Array.from({ length: 9 }, (a, e) => {
        ...
        return {
          ...
          pilar: 'cabala',
          titulo: `Ano ${o}`,
          essencia: `Tema dos pr\xf3ximos 12 meses a partir do seu anivers\xe1rio. Ciclo ${o} ativo.`,
      ...
      },
      {
        ...
        pratica:
          'Conecte-se a 1 comunidade alinhada aos seus valores. Você não precisa fazer sozinho.',
      ...
      },
      {
        ...
        pratica:
          'Ao acordar, antes de pensar, pergunte: "O que preciso saber hoje?" Anote o que vier.',
    ...
    function i(a, e) {
      return o.find((o) => o.pilar === a && String(o.id) === String(e));
    }
    function r(a, o) {
      return i(a, o) ?? e(a);
    }
    a.s([
      ...
      function (a) {
        return {
          cabala: r('cabala', a.cabala.life_path),
          astrologia: r('astrologia', a.astrologia.sol_signo),
          tantrica: r('tantrica', a.tantrica.corpo_predominante),
          odu: r('odu', a.odu.odu_principal),
          iching: r('iching', a.iching.hexagrama_dia),
        };
      },
    ]);
  },
