(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    let n = e.r(76e3).createRenderSearchParamsFromClient;
    ('function' == typeof r.default || ('object' == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, '__esModule', { value: !0 }),
      Object.assign(r.default, r),
  ...
  (e, t, r) => {
    ...
    let n = e.r(51387).createRenderParamsFromClient;
    ('function' == typeof r.default || ('object' == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, '__esModule', { value: !0 }),
      Object.assign(r.default, r),
  ...
  (e, t, r) => {
    ...
    let n = (0, e.r(85204).createAsyncLocalStorage)();
  },
  64239,
  (e, t, r) => {
    'use strict';
  ...
  (e, t, r) => {
        ...
        switch (n.type) {
          ...
          case 'validation-client':
            return (function (t, r, n) {
              var a;
              let { createExhaustiveSearchParamsProxy: o } = e.r(23202);
    ...
    function v(t, r, n, a) {
      ...
      if (n.validationSamples) {
        let { createExhaustiveSearchParamsProxy: a } = e.r(23202),
  ...
  (e, t, r) => {
          ...
          case 'request':
            if (s.asyncApiPromises && s.validationSamples)
              return (function (t, r, n, a, o) {
                let { createExhaustiveParamsProxy: i } = e.r(23202),
    ...
    function R(t, r, n) {
      let { createExhaustiveParamsProxy: a } = e.r(23202);
      return Promise.resolve(
  ...
  (e, t, r) => {
    ...
    function l({ Component: t, serverProvidedParams: r }) {
      ...
      if ('u' < typeof window) {
        let r,
          a,
          { createSearchParamsFromClient: o } = e.r(38854);
        r = o(c);
        let { createParamsFromClient: i } = e.r(45799);
        return ((a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r }));
      }
      {
        let { createRenderSearchParamsFromClient: r } = e.r(54738),
          a = r(c),
          { createRenderParamsFromClient: o } = e.r(82946),
          i = o(u);
  ...
  (e, t, r) => {
    ...
    function i({ Component: t, slots: r, serverProvidedParams: s }) {
      ...
      if ('u' < typeof window) {
        let { createParamsFromClient: a } = e.r(45799),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
      {
        let { createRenderParamsFromClient: a } = e.r(82946),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
    }
